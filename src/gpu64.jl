...
#	cl.fill!(queue, red_buff, 0.0)	# only works with OpenCL 1.2
	cl.call(queue, reset_x, (wg_size*r_chunks,1,1), nothing, red_buff, r_length32, 0.0)
	return nothing
end
...
function xty(
	...
	invstds     :: Array{Float64,1} = invstd(x, means), 
	n           :: Int              = x.n, 
	p           :: Int              = x.p, 
	p2          :: Int              = x.p2, 
	wg_size     :: Int              = 512,
